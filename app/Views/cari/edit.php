...
<div class="card">
    ...
    <form method="POST" action="/caris/<?php echo htmlspecialchars($cari['id'] ?? '', ENT_QUOTES, 'UTF-8'); ?>/update">
        ...
        <select id="type" name="cari_type" required>
            <option value="customer" <?php echo ($cari['cari_type'] ?? '') === 'customer' ? 'selected' : ''; ?>>Müşteri</option>
            <option value="supplier" <?php echo ($cari['cari_type'] ?? '') === 'supplier' ? 'selected' : ''; ?>>Tedarikçi</option>
            <option value="both" <?php echo ($cari['cari_type'] ?? '') === 'both' ? 'selected' : ''; ?>>Müşteri &amp; Tedarikçi</option>
        </select>
        ...
        <input id="phone" name="phone" type="text" value="<?php echo htmlspecialchars($cari['phone'] ?? '', ENT_QUOTES, 'UTF-8'); ?>">

        <label for="email">E-posta</label>
        <input id="email" name="email" type="email" value="<?php echo htmlspecialchars($cari['email'] ?? '', ENT_QUOTES, 'UTF-8'); ?>">
