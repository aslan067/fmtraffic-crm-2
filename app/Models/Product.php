...
class Product
{
    ...
    public static function allByCompany(int $companyId): array
    {
        ...
        $stmt = $pdo->prepare(
            'SELECT p.id, p.company_id, p.product_group_id, p.code, p.name, p.description, p.list_price, p.stock_quantity, p.status, p.created_at,
    ...
    public static function create(array $data): int
    {
        $pdo = DB::getConnection();
        $stmt = $pdo->prepare(
            'INSERT INTO products (company_id, product_group_id, code, name, description, list_price, stock_quantity, status)
             VALUES (:company_id, :product_group_id, :code, :name, :description, :list_price, :stock_quantity, :status)'
        );
